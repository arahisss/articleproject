<div class="col-md-6 d-flex" >
  <div  style="position: relative; align-items: stretch; width:100%" class="d-flex row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
    <div class="col pb-4 pt-4 ps-4 pe-4  d-flex flex-column position-static">
      ...
      <div class="content">
        ...
        <p class="card-text mb-auto">{{ mb_substr($article->text, 0, 300). '...'}}</p>
      </div>

      <!-- <a href="{{ route('article', [$article->category->code, $article->id]) }}" class="stretched-link">Продолжить чтение</a> -->
      <div class="icons p-3">
        <a href="{{ route('user.update_article', $article->id) }}" style="color: black;">
        ...
        <a href="{{ route('user.delete_article', $article->id) }}" style="color: black;">
    ...
    <!-- <div class="col-auto d-none d-lg-block">
      <svg class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail"
